                ...
                >
                    <ol className="items-center flex w-full max-w-2xl text-center text-sm font-medium text-gray-500 sm:text-base">
                        <li className="after:border-1 flex items-center text-primary-700 after:mx-6 after:hidden after:h-1 after:w-full after:border-b after:border-gray-200  sm:after:inline-block sm:after:content-[''] md:w-full xl:after:mx-10">
                            <Link to="/cart">
                                <span className="flex items-center after:mx-2 after:text-gray-200 after:content-['/']  sm:after:hidden text-blue-600">
                                    <svg
                    ...
                    <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-10 xl:gap-10">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            className="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-primary-500 focus:ring-primary-500  "
                                        >
                                            <option defaultValue>Your city</option>
                                        </select>
                                    </div>
                                    ...
                                    <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 ps-4 ">
                                        <div className="flex items-start">
                                            ...
                                            <div className="ms-4 text-sm">
                                                ...
                                                <p
                                                    id="fedex-text"
                                                    className="mt-1 text-xs font-normal text-gray-500 0"
                                                >
                                                    Get it by Tomorrow
                                                </p>
                                            </div>
